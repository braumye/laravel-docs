...
function highlightCode() {
  _toConsumableArray(document.querySelectorAll('pre code')).forEach(function (el) {
    prismjs__WEBPACK_IMPORTED_MODULE_0___default().highlightElement(el);
  });
}
...
function replaceBlockquotesWithCalloutsInDocs() {
  _toConsumableArray(document.querySelectorAll('.docs_main blockquote p')).forEach(function (el) {
    ...
    if (type) {
      switch (type) {
        case "note":
          img = '/vendor/docs/img/callouts/exclamation.min.svg';
          color = 'bg-red-600';
          break;

        case "tip":
          img = '/vendor/docs/img/callouts/lightbulb.min.svg';
          color = 'bg-purple-600';
          break;

        case "laracasts":
        case "video":
          img = '/vendor/docs/img/callouts/laracast.min.svg';
          color = 'bg-blue-600';
          break;
      }
